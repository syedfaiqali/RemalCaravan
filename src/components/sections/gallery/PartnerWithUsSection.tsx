        ...
        return (
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="1. Name" required />
                <TextField fullWidth label="2. Campsite Property Name" required />
                <TextField
                  fullWidth
                ...
                />
                <TextField fullWidth label="4. Email Address" required />
                <TextField fullWidth label="5. Complete Address of the Campsite Property" required />
                <TextField fullWidth label="6. Website of the Property (if any)" />
                <TextField fullWidth label="7. Size of the proposed location" />
              </Stack>
            </Grid>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="8. Nearest Famous Tourist Destinations" />
                <Box>
                ...
                <TextField fullWidth label="11. Suitable date & time for contact" placeholder="mm/dd/yyyy" />
                <RadioGroup row>
                ...
                <TextField fullWidth label="12. Upload recent pictures of the proposed campsite" type="file" inputProps={{ multiple: true }} />
              </Stack>
            </Grid>
          </Grid>
        )
      case 'dealer':
        return (
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                ...
                <TextField
                  ...
                  InputProps={{ startAdornment: <InputAdornment position="start">+971</InputAdornment> }}
                />
                <TextField fullWidth label="3. Email Address" required />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="6. Suitable date & time for contact" placeholder="mm/dd/yyyy" />
                <RadioGroup row>
                  <FormControlLabel value="8-11" control={<Radio />} label="8am-11am" />
                  <FormControlLabel value="11-2" control={<Radio />} label="11am-2pm" />
                  <FormControlLabel value="2-5" control={<Radio />} label="2pm-5pm" />
                ...
                <Box>
                  ...
                  <FormGroup>
                    <FormControlLabel control={<Checkbox />} label="Tour & Travel" />
                    <FormControlLabel control={<Checkbox />} label="Car Rental Business" />
                    <FormControlLabel control={<Checkbox />} label="Automobile Dealership" />
                    <FormControlLabel control={<Checkbox />} label="Hotel / Guest House / Resort / Cottage Business" />
                    <FormControlLabel control={<Checkbox />} label="Managing Foreign Travellers" />
                  </FormGroup>
                </Box>
              </Stack>
            </Grid>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                ...
                />
                <TextField fullWidth label="3. Email Address" required />
                <TextField fullWidth label="4. Complete Address of Business / Residence with PIN Code" required />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
              ...
              <Stack spacing={2.5}>
                ...
                <Box>
                  ...
                  <FormGroup>
                    ...
                    <FormControlLabel control={<Checkbox />} label="Family and Friends" />
                    <FormControlLabel control={<Checkbox />} label="I opted for the services" />
                    <FormControlLabel control={<Checkbox />} label="Any other platform, please specify" />
                  </FormGroup>
                </Box>
              </Stack>
            </Grid>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                ...
                />
                <TextField fullWidth label="3. Email Address" required />
                <TextField fullWidth label="4. Home Address" required />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
                    5. Estimated Budget
                  </Typography>
                ...
                <Select fullWidth defaultValue="">
                  <MenuItem value="">6. For number of people</MenuItem>
                  <MenuItem value="2-3">2-3</MenuItem>
                  <MenuItem value="4-5">4-5</MenuItem>
                  <MenuItem value="6+">6+</MenuItem>
                </Select>
                <Select fullWidth defaultValue="">
                  <MenuItem value="">7. Estimated time available (in months)</MenuItem>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="8. Suitable date & time for contact" placeholder="mm/dd/yyyy" />
                <RadioGroup row>
                  <FormControlLabel value="8-11" control={<Radio />} label="8am-11am" />
                  <FormControlLabel value="11-2" control={<Radio />} label="11am-2pm" />
                  <FormControlLabel value="2-5" control={<Radio />} label="2pm-5pm" />
                ...
                <TextField fullWidth label="10. Specific requirements (if any)" />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
                  ...
                  >
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Bed option" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Washroom" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Kitchen" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Lounge" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Dining Options" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Storage" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Heating" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Gadgets" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Water Tanks" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Seating and Upholstery" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                    <FormControlLabel sx={{ width: 'max-content' }} control={<Checkbox />} label="Entertainment System" labelTypographyProps={{ sx: { whiteSpace: 'nowrap' } }} />
                  </FormGroup>
                </Box>
              </Stack>
            </Grid>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                ...
                />
                <TextField fullWidth label="3. Email Address" required />
                <TextField fullWidth label="4. Model Name & Details of the Caravan" required />
                <Select fullWidth defaultValue="">
                  <MenuItem value="">5. Year of Manufacturing of the Vehicle</MenuItem>
                ...
                <Select fullWidth defaultValue="">
                  <MenuItem value="">6. Year of Fabrication of the Caravan</MenuItem>
                  <MenuItem value="2024">2024</MenuItem>
                  <MenuItem value="2023">2023</MenuItem>
                  <MenuItem value="2022">2022</MenuItem>
                  <MenuItem value="2021">2021</MenuItem>
                ...
                <Select fullWidth defaultValue="">
                  <MenuItem value="">7. Registration: Private or Commercial</MenuItem>
                  <MenuItem value="private">Private</MenuItem>
                  <MenuItem value="commercial">Commercial</MenuItem>
                </Select>
                <TextField fullWidth label="8. Insurance Valid Till" placeholder="mm/dd/yyyy" />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <Select fullWidth defaultValue="">
                  <MenuItem value="">10. Sitting Capacity</MenuItem>
                  <MenuItem value="4">4</MenuItem>
                  <MenuItem value="6">6</MenuItem>
                  <MenuItem value="8">8</MenuItem>
                </Select>
                <Select fullWidth defaultValue="">
                  <MenuItem value="">11. Sleeping Capacity</MenuItem>
                  <MenuItem value="2">2</MenuItem>
                  <MenuItem value="4">4</MenuItem>
                  <MenuItem value="6">6</MenuItem>
                </Select>
                <TextField fullWidth label="12. Amenities inside the Caravan" />
                <Box>
                  <Typography sx={{ fontFamily: '"Plus Jakarta Sans", sans-serif', fontWeight: 700, mb: 1 }}>
                ...
                <TextField fullWidth label="14. Any other issues with the Caravan" />
                <TextField fullWidth label="15. Suitable date & time for contact" placeholder="mm/dd/yyyy" />
                <RadioGroup row>
                  <FormControlLabel value="8-11" control={<Radio />} label="8am-11am" />
                  <FormControlLabel value="11-2" control={<Radio />} label="11am-2pm" />
                  <FormControlLabel value="2-5" control={<Radio />} label="2pm-5pm" />
                ...
                <TextField fullWidth label="16. Upload recent pictures of the proposed Caravan" type="file" inputProps={{ multiple: true }} />
              </Stack>
            </Grid>
          </Grid>
        )
        ...
        return (
          <Grid container spacing={3}>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="1. Name" required />
                <TextField fullWidth label="2. Company Name" required />
                <TextField
                  fullWidth
                  label="3. Contact Number"
                  required
                ...
                />
                <TextField fullWidth label="4. Email Address" required />
                <TextField fullWidth label="5. Complete Address of the Office" required />
              </Stack>
            </Grid>
            <Grid size={{ xs: 12, md: 6 }}>
              <Stack spacing={2.5}>
                <TextField fullWidth label="6. Website of the Company (if any)" />
                <TextField fullWidth label="7. No. of Years into Tours & Travel Business" />
                <TextField fullWidth label="8. Suitable date & time for contact" placeholder="mm/dd/yyyy" />
                <RadioGroup row>
                  <FormControlLabel value="8-11" control={<Radio />} label="8am-11am" />
                  <FormControlLabel value="11-2" control={<Radio />} label="11am-2pm" />
      ...
      <Container maxWidth="xl" sx={{ px: { xs: 3, md: 8 } }}>
        <MotionSection delay={150}>
          ...
          >
            ...
            {activePartner ? (
              <Box sx={{ bgcolor: '#fff7ee', borderRadius: '24px', p: { xs: 3, md: 5 } }}>
                <Button
